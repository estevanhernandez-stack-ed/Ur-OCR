...
namespace RoRoRo.UrOcr.Diagnostics;

/// <summary>
/// Append-only diagnostics sink under %LOCALAPPDATA%\626Labs\rororo-ur-ocr\logs.
...
/// ur-ocr.1.log (2 MB worst case on disk). Never throws: a failed write is
...
internal static class DiagLog
{
    ...
    public static string Directory { get; set; } = Path.Combine(
        ...
        "626Labs", "rororo-ur-ocr", "logs");

    public static string CurrentLogPath => Path.Combine(Directory, "ur-ocr.log");
    public static string RolledLogPath => Path.Combine(Directory, "ur-ocr.1.log");
